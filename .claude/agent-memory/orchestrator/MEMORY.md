...
- [Job corpus & ATS crawler](project_job_corpus_indexing.md) — shared `job_postings` corpus + GH/Lever/Ashby crawler (ADR-019/015); approved RLS exception; 3 migrations + crawl layer + 2 edge fns shipped & validated 2026-06-22 (PR #29), deploy JB-gated.
