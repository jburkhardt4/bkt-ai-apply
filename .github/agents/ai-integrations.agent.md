...
- Confirm pinned model names against `docs/conventions/model-routing.md` as the single source. Pinned versions (Opus 4.6, GPT-5, Gemini 2.5) are drift-prone — never hardcode model names anywhere else.
