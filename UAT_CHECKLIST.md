...
- [ ] **3.2 — Years-of-skill + screeners (Greenhouse).** Salesforce 8 / Architect 5 / Apex 2 / LWC 6
...
- [ ] **3.3 — Notice period accept-list (NEW, `77ae094`).** On a posting with a notice-period
...
- [ ] **4.1 — Not squished.** With the panel open on a scored job, section headings have weight +
