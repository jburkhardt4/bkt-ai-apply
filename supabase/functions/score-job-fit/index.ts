...
const DEFAULT_SYSTEM_PROMPT = [
  ...
  'When the profile includes a "resumeText" field (the candidate\'s full master',
  'resume), treat it as the authoritative source of their experience over the',
  'keyword lists, which are only supplementary hints.',
  '',
